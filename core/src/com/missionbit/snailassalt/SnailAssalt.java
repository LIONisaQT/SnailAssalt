...
public class SnailAssalt extends ApplicationAdapter  {
    ...
    private Sprite
            ...
            /* tutorial pages */ tutor1, tutor2, tutor3, tutor4, tutor5, tutor6, tutor7, tutor8,
            /* backgrounds */ menu, gameover, win, levelSelect, shop, laun,
            /* UI */ hpBar, waterBar, saltBar, progBarSnail;
    //weapwns start
    ...
    public void updateGame() {
        ...
        if (gameState == GameState.MAINMENU) { //in main menu
            ...
            if (backButtonLevelSelect.isPressed())
                backButtonLevelSelect.pressedAction();
    ...
    public void drawGame() {
        ...
        if (gameState == GameState.MAINMENU) {
            ...
            if (tutState == TutorialState.PAGE8) {
                ...
                if (tutState == TutorialState.PAGE1) {tutor1.draw(batch);}
                else if (tutState == TutorialState.PAGE2) {tutor2.draw(batch);}
                else if (tutState == TutorialState.PAGE3) {tutor3.draw(batch);}
                else if (tutState == TutorialState.PAGE4) {tutor4.draw(batch);}
                else if (tutState == TutorialState.PAGE5) {tutor5.draw(batch);}
                else if (tutState == TutorialState.PAGE6) {tutor6.draw(batch);}
                else {tutor7.draw(batch);}
            ...
            shapeRenderer.rect(0, 0, ((float) currentLevel.enemyCount / currentLevel.totalEnemies) * width, 20);
            shapeRenderer.end();
            batch.begin();
